...
//        val matriz: Array<Array<ArrayList<Particula>>>(m)
//        for (i in 0 until m) {
//            for (j in 0 until m) {
//                matriz[i][j] = ArrayList<Particula>()
//            }
//        }
//        var maxR = 0.0
//        for (p in particulas) {
...
//
//        internal var vecinos: ArrayList<Particula>
//
//        init {
//            vecinos = ArrayList()
//        }
...
//            try {
//                BufferedWriter(OutputStreamWriter(
//                        FileOutputStream("tiempo_CIM.csv"), "utf-8")).use { writer ->
//                    for (m in 1..maxM) {
